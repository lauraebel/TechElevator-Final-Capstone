...
constraint fk_system_user_id foreign key (system_user_id) references system_user(system_user_id),
...
constraint fk_tool_tool_id foreign key (tool_id) references tool(tool_id),
